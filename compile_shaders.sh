...
slangc shaders/compute.slang -profile spirv_1_6 -target spirv-asm -o shaders/disassembled_compute.spvasm -entry computeMain -emit-spirv-directly -fvk-use-entrypoint-name
slangc shaders/vertex.slang -profile spirv_1_6 -target spirv-asm -o shaders/disassembled_vertex.spvasm -entry vertexMain -emit-spirv-directly -fvk-use-entrypoint-name
slangc shaders/fragment.slang -profile spirv_1_6 -target spirv-asm -o shaders/disassembled_fragment.spvasm -entry fragmentMain -emit-spirv-directly -fvk-use-entrypoint-name
